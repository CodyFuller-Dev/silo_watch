...
# this shoots the user right to the correct URL with no guesswork
@app.route('/')
def index():
...
def city_wrapper():
    ...
    # when the API is called up and no data is returned for whatever reason an error message is sent
